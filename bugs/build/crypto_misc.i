...
# 40 "crypto_misc.c" 2
# 1 "../ssl/crypto_misc.h" 1
# 42 "../ssl/crypto_misc.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdbool.h" 1 3 4
# 43 "../ssl/crypto_misc.h" 2
# 1 "../crypto/crypto.h" 1
# 42 "../crypto/crypto.h"
# 1 "../crypto/bigint_impl.h" 1
# 74 "../crypto/bigint_impl.h"
...
# 43 "../crypto/crypto.h" 2
# 1 "../crypto/bigint.h" 1
# 34 "../crypto/bigint.h"
# 1 "../crypto/crypto.h" 1
# 35 "../crypto/bigint.h" 2
...
# 44 "../ssl/crypto_misc.h" 2
# 1 "../crypto/bigint.h" 1
# 45 "../ssl/crypto_misc.h" 2
# 88 "../ssl/crypto_misc.h"
struct _x509_ctx
{
    char *ca_cert_dn[6];
    char *cert_dn[6];
...
# 100 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 100 "../ssl/crypto_misc.h"
        basic_constraint_present;
    
# 101 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 101 "../ssl/crypto_misc.h"
        basic_constraint_is_critical;
    
# 102 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 102 "../ssl/crypto_misc.h"
        key_usage_present;
    
# 103 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 103 "../ssl/crypto_misc.h"
        key_usage_is_critical;
    
# 104 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 104 "../ssl/crypto_misc.h"
        subject_alt_name_present;
    
# 105 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 105 "../ssl/crypto_misc.h"
        subject_alt_name_is_critical;
    
# 106 "../ssl/crypto_misc.h" 3 4
   _Bool 
# 106 "../ssl/crypto_misc.h"
        basic_constraint_cA;
...
# 121 "../ssl/crypto_misc.h"
int x509_new(const uint8_t *cert, int *len, X509_CTX **ctx);
void x509_free(X509_CTX *x509_ctx);
# 164 "../ssl/crypto_misc.h"
...
int asn1_get_bool(const uint8_t *buf, int *offset, 
# 170 "../ssl/crypto_misc.h" 3 4
                                                  _Bool 
# 170 "../ssl/crypto_misc.h"
                                                       *val);
...
# 171 "crypto_misc.c"
    ...
    gettimeofday(&tv, 
# 179 "crypto_misc.c" 3 4
                     ((void *)0)
# 179 "crypto_misc.c"
                         );
    ep = (uint64_t *)entropy_pool;
    ep[0] ^= ((((uint64_t)tv.tv_sec)<<32) | tv.tv_usec);
    ep[1] ^= rand();


    MD5_Init(&rng_digest_ctx);
    MD5_Update(&rng_digest_ctx, entropy_pool, 32);
    MD5_Final(digest, &rng_digest_ctx);


    AES_set_key(&rng_ctx, digest, (const uint8_t *)ep, AES_MODE_128);
    memcpy(rand_data, entropy_pool, num_rand_bytes < 32 ?
    num_rand_bytes : 32);
    AES_cbc_encrypt(&rng_ctx, rand_data, rand_data, num_rand_bytes);


    for (i = 32 -1; i >= 16 ; i--)
        entropy_pool[i] = entropy_pool[i-16];


    memcpy(entropy_pool, digest, 16);
