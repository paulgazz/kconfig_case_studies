...
def filter_common(dimacs_, cdir_, configs_):
    ...
    #print("Only in failed configs (" + str(fcount) + "/" + str(fcount+pcount) +  "): ", end='')
    #print("\"" + str(fcount) + "/" + str(fcount + pcount) + "\",\"", end='')
...
def analyze_clang7(dimacs_, cdir_, jsonfile_):
    # read json file
    ...
    for datum in rawdata:
        ...
        if 'investigation' in datum:
            ...
            print(datum["hash"] + " /  " + datum['source_file'] + ":" + str(datum['location']) + ": ", end='')
            filter_common(dimacs_, cdir_, cset)
            ...
            print(datum['hash'] + ":" + str(datum['source_file']) + "," + str(datum['location']) + ": ", end='')
...
if __name__ == "__main__":
    ...
    if len(args) == 3:
        print("Not enough arguments: <dimacs> <sampledir> <json>")
        sys.exit(2)
    ...
    analyze_clang7(dimacs, sampledir, jsonfile)
